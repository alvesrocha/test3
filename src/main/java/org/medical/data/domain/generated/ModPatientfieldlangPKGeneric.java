...
/**
 * The primary key class for the mod_patientfieldlang database table.
 * 
 */
@MappedSuperclass
public class ModPatientfieldlangPKGeneric implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ModPatientfieldlangPKGeneric)) {
			return false;
		}
		ModPatientfieldlangPKGeneric castOther = (ModPatientfieldlangPKGeneric)other;
		return 
