...
/**
 * The primary key class for the mod_defaultclinicfieldlang database table.
 * 
 */
@MappedSuperclass
public class ModDefaultclinicfieldlangPKGeneric implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ModDefaultclinicfieldlangPKGeneric)) {
			return false;
		}
		ModDefaultclinicfieldlangPKGeneric castOther = (ModDefaultclinicfieldlangPKGeneric)other;
		return 
