...
/**
 * The primary key class for the mod_defaultdeptfieldlang database table.
 * 
 */
@MappedSuperclass
public class ModDefaultdeptfieldlangPKGeneric implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ModDefaultdeptfieldlangPKGeneric)) {
			return false;
		}
		ModDefaultdeptfieldlangPKGeneric castOther = (ModDefaultdeptfieldlangPKGeneric)other;
		return 
