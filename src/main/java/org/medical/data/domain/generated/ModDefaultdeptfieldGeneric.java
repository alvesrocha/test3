...
/**
 * The persistent class for the mod_defaultdeptfields database table.
 * 
 */
@MappedSuperclass
public class ModDefaultdeptfieldGeneric implements Serializable {
	...
	@OneToMany(mappedBy="modDefaultdeptfield")
	private List<ModDefaultdeptfieldlang> modDefaultdeptfieldlangs;

	public ModDefaultdeptfieldGeneric() {
	}
